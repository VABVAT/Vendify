...
export default function ListCard({edit, index, image, price, name, sold, id, description, email }) {
            ...
            <div key={index} className="flex w-full h-[200px] items-center border border-gray-800 rounded-lg shadow-md mb-4 bg-Gld overflow-hidden">
                ...
                <div className="w-[70%] h-full flex flex-col justify-between p-6">
                    ...
                    <div className="flex space-x-4 mt-4">
                        ...
                        {sold ? (
                            <button className="px-6 py-2 bg-gray-400 text-white rounded-lg bg-red-500 cursor-not-allowed" disabled>Delete Listing</button>
                        ) : (
                            <button className="px-6 py-2 bg-black text-white rounded-lg hover:bg-red-500 transition" onClick={() => setConfirmation(true)}>
                                Delete Listing
                            </button>
                        )}
                    </div>
